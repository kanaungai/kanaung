...
function DashboardCard({ selectedId, setSelectedId }) {
  ...
  return (
    ...
    >
      ...
      {/* Browser chrome */}
      <div className="flex items-center gap-4 px-5 py-3 border-b" style={{ background: "hsl(220 18% 98.5%)", borderColor: "hsl(220 16% 87%)" }}>
        ...
        <div className="flex-1 flex justify-center">
          <div className="flex items-center gap-2 px-3 py-1 rounded-md text-[10px] font-mono"
            style={{ background: "hsl(220 16% 94%)", border: "1px solid hsl(220 16% 88%)", color: "hsl(220 12% 52%)", minWidth: 200, justifyContent: "center" }}>
      ...
      {/* Mobile: scaled viewport */}
      <div className="block sm:hidden overflow-hidden" style={{ aspectRatio: "4/3" }}>
        <div style={{ width: INNER_W, transformOrigin: "top left", transform: `scale(calc(100vw / ${INNER_W}))` }}>
          <DashboardBody selectedId={selectedId} setSelectedId={setSelectedId} minHeight={400} />
        </div>
      </div>
